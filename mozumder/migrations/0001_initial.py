# Generated by Django 3.0.8 on 2020-07-05 07:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin_list_display', models.BooleanField(blank=True, null=True)),
                ('admin_list_display_links', models.BooleanField(blank=True, null=True)),
                ('admin_readonly_field', models.BooleanField(blank=True, null=True)),
                ('admin_search', models.BooleanField(blank=True, null=True)),
                ('max_length', models.BooleanField(blank=True, null=True)),
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mozumder.TrackedModel')),
            ],
        ),
        migrations.CreateModel(

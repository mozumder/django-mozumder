# Generated by Django 3.1 on 2020-08-17 03:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('permission_code', models.CharField(blank=True, max_length=80, null=True, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Device',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('permission_code', models.CharField(blank=True, max_length=80, null=True, unique=True)),
                ('human_readable_permission_name', models.CharField(blank=True, max_length=80, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='HostName',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('params', models.CharField(blank=True, max_length=512, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='QueryString',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('select_on_save', models.BooleanField(blank=True, null=True)),
                ('constraints', models.ManyToManyField(to='mozumder.Constraint')),
                ('default_permissions', models.ManyToManyField(to='mozumder.DefaultPermission')),
                ('get_latest_by', models.ManyToManyField(related_name='latest_fields', through='mozumder.Latest', to='mozumder.TrackedField')),
                ('indexes', models.ManyToManyField(to='mozumder.Index')),
        ...
        migrations.AddField(
            model_name='constraint',
            name='q',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mozumder.query'),
        ),
        migrations.AddConstraint(
            model_name='browser',
